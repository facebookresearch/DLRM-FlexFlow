...
#define GASNETI_BUILD_ID "Thu Dec  5 13:44:24 PST 2019 dheevatsa"
#define GASNETI_CONFIGURE_ARGS "'--enable-ibv' '--enable-mpi' '--disable-portals' '--disable-mxm' '--enable-pthreads' '--enable-segment-fast' '--enable-par' '--disable-seq' '--disable-parsync' '--enable-mpi-compat' '--with-ibv-spawner=mpi' '--disable-ibv-rcv-thread' '--disable-aligned-segments' '--disable-pshm' '--disable-fca' '--enable-ibv-multirail' '--with-ibv-max-hcas=4' '--with-ibv-physmem-max=2/3' '--disable-ibv-physmem-probe' '--prefix=/private/home/dheevatsa/flexflow/DLRM_FlexFlow/GASNet-2019.9.0'"
