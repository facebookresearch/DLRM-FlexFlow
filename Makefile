...
GEN_GPU_SRC	?= src/ops/conv_2d.cu src/runtime/model.cu src/ops/pool_2d.cu src/ops/batch_norm.cu src/ops/linear.cu\
		...
		src/ops/mse_loss_3d.cu src/runtime/initializer_kernel.cu src/runtime/optimizer_kernel.cu src/runtime/accessor_kernel.cu\
		src/ops/transpose.cu src/runtime/cuda_helper.cu $(app).cu# .cu files
