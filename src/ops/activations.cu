...
//     // }
//     argmap.set_point(*it, TaskArgument(&handle, sizeof(FFHandler)));
//     // ActivationMeta m = ActivationMeta(handle);
//     // if (mode == "relu") {
//     //   m.mode = CUDNN_ACTIVATION_RELU;
//     // } else if (mode == "sigmoid") {
//     //   m.mode = CUDNN_ACTIVATION_SIGMOID;
//     // } else if (mode == "elu") {
//     //   m.mode = CUDNN_ACTIVATION_ELU;
//     // } else if (mode == "tanh") {
//     //   m.mode = CUDNN_ACTIVATION_TANH;
//     // } else if (mode == "idendity") {
//     //   m.mode = CUDNN_ACTIVATION_IDENTITY;
//     // } else {
//     //   throw 255;
//     // }
//     // argmap.set_point(*it, TaskArgument(&m, sizeof(ActivationMeta)));
...
//   FFHandler handle = *((const FFHandler*) task->local_args);
//   ActivationMeta* m = new ActivationMeta(handle);
//   // ActivationMeta* m = *((ActivationMeta**) task->local_args);
//   assert(regions.size() == 2);
//   assert(task->regions.size() == 2);
//   TensorAccessorR<float, DIM> acc_input(regions[0], task->regions[0], FID_DATA, ctx, runtime);
//   TensorAccessorR<float, DIM> acc_output(regions[1], task->regions[1], FID_DATA, ctx, runtime);
