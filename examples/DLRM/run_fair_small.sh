...
./dlrm -ll:cpu 8 -ll:fsize 14000 -ll:zsize 20000 --arch-sparse-feature-size 64 --arch-embedding-size 3000000-3000000-3000000-3000000-3000000-3000000-3000000-3000000 --embedding-bag-size 38 --arch-mlp-bot 1024-1024-1024-64 --arch-mlp-top 576-1024-1024-1024-1024-1024-1024-1024-1024-1 --epochs 20 --batch-size 64 --data-size 64 -dm:memorize -ll:gpu 1 -ll:util 12 -ll:dma 4 --strategy ../../../../../src/runtime/dlrm_strategy_emb_8_gpu_8_node_2.pb
...
#-dm:memoize  
#-lg:prof 2 -lg:prof_logfile prof_%.gz 
